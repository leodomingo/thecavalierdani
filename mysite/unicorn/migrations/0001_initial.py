...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='unicorn.Article')),
            ],
        ),
        migrations.CreateModel(
            name='ArticleImage',
        ...
        migrations.AddField(
            ...
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='unicorn.Tag'),
        ),
        migrations.AddField(
            model_name='articleauthor',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='unicorn.Author'),
        ),
        migrations.AddField(
            model_name='article',
            name='authors',
            field=models.ManyToManyField(through='unicorn.ArticleAuthor', to='unicorn.Author'),
        ),
        migrations.AddField(
            model_name='article',
            name='images',
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(through='unicorn.ArticleTag', to='unicorn.Tag'),
        ),
    ]
